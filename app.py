...
ord=list(df1[df1['batsman_run']==6]['BattingTeam'].value_counts().index)
ax=sns.countplot(data=df1[df1['total_run']==6],x='BattingTeam',order=ord)

st.header("Number of Sixes : ")
st.image("pic.png",width=800)
